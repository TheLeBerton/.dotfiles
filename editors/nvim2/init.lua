...
keys.set("n", "<leader>rn", vim.lsp.buf.rename)
keys.set("n", "gd", vim.lsp.buf.definition)
keys.set("n", "gr", vim.lsp.buf.references)
keys.set("n", "gi", vim.lsp.buf.implementation)
keys.set("n", "K", vim.lsp.buf.hover)
